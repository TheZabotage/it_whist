defmodule ItWhist.Accounts.Account do
  use Ecto.Schema
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, ItWhist.Repo)
  ...
  """
  def valid_password?(%ItWhist.Accounts.Account{hashed_password: hashed_password}, password)
